					...
					<div class="navbar-header">
						...
						<h1>
							<a class="navbar-brand" href="index.php">
								<span class="fa fa-area-chart"></span> Tradeshacker
								<span class="dashboard_text">Money Trading</span>
							</a>
						</h1>
					</div>
								...
								<ul class="treeview-menu">
									...
									<li class="treeview">
										...
										<ul class="treeview-menu">
											<li>
												<a href="finance.php">
													<i class="fa fa-angle-right"></i> Financial History</a>
											</li>
										</ul>
									</li>
									<li>
